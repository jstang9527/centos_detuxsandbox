...
class Report:
    def __init__(self, sample_filepath, sandbox_result):
        ...
        self.report = {}
        # print("cpu_arch=%s;interpreter=%s;sample_filepath=%s;pcap_filepath=%s;post_exec_result=%s;start_time=%s;end_time=%s;error_in_exec=%s" 
        # %(self.cpu_arch, self.interpreter,self.sample_filepath,self.pcap_filepath,self.post_exec_result,self.start_time,self.end_time,self.error_in_exec))
        # print("^" * 20)
